...
from LinuxDsahboard.settings import TIME_JS_REFRESH, TIME_JS_REFRESH_LONG, TIME_JS_REFRESH_NET
...
def getall(request):
    return render_to_response('main.html', {'time_refresh': time_refresh,
                                            ...
                                            'time_refresh_net': time_refresh_net}, context_instance=RequestContext(request))
